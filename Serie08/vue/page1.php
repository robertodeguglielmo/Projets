			...
			<section class="col-lg-10">
				<div class="row">
					<article class="col-sm-8">
						<img class="img-responsive" src="../vue/images/1.jpg" alt="">
						<p>Charles Michel avec les étudiants en Erasmus</p>
						
					</article>
					<article class="col-sm-4">
						<img class="img-responsive" src="../vue/images/2.jpg" alt="">
						<p>COP23:"La Belgique partage le sentiment d'urgence et agit</p>
					</article>
					<article class="col-sm-4">
						<img class="img-responsive" src="../vue/images/3.jpg" alt="">
						<p>Le journaliste Hugo Clément quitte «Quoditien»</p>
					</article>

					<article class="col-sm-4">
						<img class="img-responsive" src="../vue/images/4.jpg" alt="">
						<p>Un sanglier coincé dans une piscine à Erpent</p>
					</article>
					<article class="col-sm-8">
						<img class="img-responsive" src="../vue/images/5.jpg" alt="">
